...
class qPrefMedia : public QObject
{
	...
	Q_PROPERTY(QString google_photos_token READ google_photos_token WRITE set_google_photos_token NOTIFY google_photos_tokenChanged)
...
public:
	...
	static QString google_photos_token() { return prefs.google_photos_token; }
...
public slots:
	...
	static void set_google_photos_token(const QString &value);
...
signals:
	...
	void google_photos_tokenChanged(const QString &value);
...
private:
	...
	static void disk_google_photos_token(bool doSync);
};
